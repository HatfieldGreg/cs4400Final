        ...
        while($row = $resultMe->fetch_assoc())
         {
            ...
            $Type = $row['SurveyType'];
			if($Type == 0){
			$ResearchSurvey.= "<div class =\"innerRow\"><span class=\"fifty padL\">$Survey</span><span class=\"padL selectRow\" onclick =\"QualtricsfilterSelect($SID)\">|  Add Filter  |</span><span class=\"padL selectRow\" onclick =\"Sure3($SID)\">|  Delete Study  |</span></div>";
			}
			else{
            $ResearchSurvey.= "<div class =\"innerRow\"><span class=\"fifty padL\">$Survey</span><span class=\"padL selectRow\" onclick =\"testSelect($SID)\">|  Edit Study  |</span><span class=\"padL selectRow\" onclick =\"filterSelect($SID)\">|  Add Filter  |</span><span class=\"padL selectRow\" onclick =\"Sure3($SID)\">|  Delete Study  |</span></div>";
			}
        }
    }           
