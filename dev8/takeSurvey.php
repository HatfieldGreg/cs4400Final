...
if ($result->num_rows > 0) {
	...
	<input type="text" id = "section" required name ="sectNumber"   maxlength="14"/>
	</div>';
     echo "<input type = \"submit\" class = \"cBtn\" value =\"submit\" name = 'SectionNum' >
	 </form>";
	}
