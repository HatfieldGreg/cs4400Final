...
echo "<div id = \"studyDiv\" class = \"\">";	  
	//gets surveys and students who have taken them for the last 4 months
		$UserSurvey = "select distinct s.description, s.idSurvey from StudentSurvey ss inner join Survey s on ss.idSurvey = s.idSurvey where s.DateCreate >= CURDATE()-120 order by s.idSurvey desc";
