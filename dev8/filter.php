...
<input type=\"submit\" class=\"cBtn fLeft\" name=\"selectAll\" value=\"select All\" />
<input type=\"submit\" class=\"cBtn fLeft\" name=\"deselectAll\" value=\"deselect All\" />
</form>";
...
if ($result->num_rows > 0) {
    ...
    echo "<input type = \"submit\" class='cBtn fLeft' value = \"Submit\"><br /><br /><br />";
    while($row = $result->fetch_assoc())
     {	 
